                                 ...
                                 cy_http_message_body_t *http_message_body)
{
    ...
    case CY_HTTP_REQUEST_POST:
        ...
        else
        {
            ...
            else if(!strncmp((char *)http_message_body->data, PUMP1, 5))
			{
...
void server_task(void *arg)
{
    ...
    cyhal_gpio_init(P5_7,CYHAL_GPIO_DIR_OUTPUT,CYHAL_GPIO_DRIVE_STRONG,1u);
    cyhal_gpio_init(P5_6,CYHAL_GPIO_DIR_OUTPUT,CYHAL_GPIO_DRIVE_STRONG,1u);
    cyhal_gpio_init(P5_5,CYHAL_GPIO_DIR_OUTPUT,CYHAL_GPIO_DRIVE_STRONG,1u);
    cyhal_gpio_init(P5_4,CYHAL_GPIO_DIR_OUTPUT,CYHAL_GPIO_DRIVE_STRONG,1u);
...
#define PUMP_ON_TIME (500u)
#define PUMP_1_PIN   (P5_4)
#define PUMP_2_PIN   (P5_5)
#define PUMP_3_PIN   (P5_6)
#define PUMP_4_PIN   (P5_7)
...
#else
            sprintf(sensor_value_buffer, "PWM Duty Cycle: %d, Moisture Sns1:%d mV, Sns2:%d mV, Sns3:%d mV, Sns4:%d mV \n", duty_cycle_reading,adc_result[0],adc_result[1],adc_result[2],adc_result[3]);
